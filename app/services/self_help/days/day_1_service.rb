    ...
    class Day1Service < DayBaseService
      ...
      def complete_exercise
        ...
        completion_message = <<~MARKDOWN
          ...
          **Ваши достижения сегодня:**
          ...
          🧠 **Что вы развили:**
          1. 🔍 Навык замечать блуждания ума
          2. 🌊 Способность наблюдать без вовлечения
          3. 🧭 Якорь для возвращения в настоящее
          4. 🛡️ Пространство между стимулом и реакцией
          
          📈 **Научный факт:** После 8 недель регулярной практики у 85% людей наблюдается снижение уровня тревоги и улучшение эмоциональной регуляции.
          
          🎯 **Рекомендация на завтра:** Повторите практику в любое удобное время. Консистентность важнее продолжительности!
        MARKDOWN
      ...
      def resume_session
        ...
        when "day_1_exercise_in_progress"
          ...
          # Если состояние не определено или не соответствует дню 1
