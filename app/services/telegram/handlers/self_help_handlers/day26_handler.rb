  ...
  module Handlers
    module SelfHelpHandlers
      class Day26Handler < BaseHandler
        def process
          log_info("Processing day 26 callback: #{@callback_data} - User: #{@user.telegram_id}, Chat: #{@chat_id}")
          ...
          begin
            ...
            log_error("Error in Day26Service processing", e)
            send_message(
              text: "Произошла ошибка при выполнении упражнения 'Цепочка ценностей'. Пожалуйста, попробуйте еще раз."
            )
