  ...
  module Handlers
    module SelfHelpHandlers
      class Day27Handler < BaseHandler
        def process
          log_info("Processing day 27 callback: #{@callback_data} - User: #{@user.telegram_id}, Chat: #{@chat_id}")
          ...
          begin
            ...
            log_error("Error in Day27Service processing", e)
            send_message(
              text: "Произошла ошибка при выполнении упражнения 'Нейрохакинг радости'. Пожалуйста, попробуйте еще раз."
            )
