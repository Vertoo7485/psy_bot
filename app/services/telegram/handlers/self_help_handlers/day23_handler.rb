  ...
  module Handlers
    module SelfHelpHandlers
      class Day23Handler < BaseHandler
        def process
          log_info("Processing day 23 callback: #{@callback_data} - User: #{@user.telegram_id}, Chat: #{@chat_id}")
          
          begin
            # Получаем сервис дня 23
            ...
            log_error("Error in Day23Service processing", e)
            send_message(
